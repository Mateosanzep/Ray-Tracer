...
public class Sphere extends Object3D{
    ...
    public Vector3D getNormal(Vector3D hitPoint) {
        return hitPoint.VectorSubstract(this.center).Normalize();
    }
    ...
    public Intersection intersect(Ray ray) {
        ...
        if (hit) {
            ...
            Vector3D normal = hitPoint.VectorSubstract(this.center).Normalize();
            return new Intersection(t, object, true, hitPoint, normal);
        }

        return new Intersection(t, object, false);
    }
}
